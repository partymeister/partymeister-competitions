...
/**
 * Class PartymeisterCompetitionsApiEntryTest
 */
class PartymeisterCompetitionsApiEntryTest extends TestCase
{
    ...
    /** @test */
    public function fails_to_show_a_single_entry_without_permission()
    {
        $record = create_test_entry();
        $this->json(
            'GET',
